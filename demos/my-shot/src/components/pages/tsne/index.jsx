        ...
        <Card>
          <CardContent>
            ...
            <Box sx={{ mt: 2 }}>
              ...
              <Typography variant="body2" gutterBottom>
                <strong>t-SNE Parameters:</strong> Perplexity={Math.min(16, Math.floor(data.words.length / 2))}, Learning Rate=10, Exaggeration=1.0
              </Typography>
              <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mt: 1, fontStyle: 'italic' }}>
                Parameters optimized based on Gove et al. (2022) empirical study. Similar words should appear closer together in the 2D space.
              </Typography>
            </Box>
              ...
              <Paper elevation={1} sx={{ p: 2, mt: 3, backgroundColor: '#e3f2fd' }}>
                ...
                {applyNormalization && (
                  <Typography variant="body2" sx={{ mb: 1 }}>
                    <strong>Normalization:</strong> Raw t-SNE output can have extreme coordinate values.
                    Normalization scales all points to a [-1, 1] range, making the visualization easier to interpret.
                    This doesn't change relative positions or distances between points.
                  </Typography>
                )}
                {showConnectingLines && (
                  <Typography variant="body2" sx={{ mb: 1 }}>
                    <strong>Connecting Lines:</strong> The dashed lines show Euclidean distances between points.
                    Shorter distances mean more similar word meanings in the reduced space.
                  </Typography>
                )}
                {showAngles && (
                  <Typography variant="body2">
                    <strong>Angles:</strong> The angles between vectors from the origin represent cosine similarity.
